 ...
 * @author Usuario
 */
public class Cancelamento123 extends javax.swing.JFrame {

    /**
     * Creates new form agenda
     */
    public Cancelamento123() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cancelamento123.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cancelamento123().setVisible(true);
            }
        });
    }
